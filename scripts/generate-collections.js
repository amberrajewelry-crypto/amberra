...
const COLLS = [
  { slug: 'solar', label: 'The Solar Collection', lbl: 'Warmth & Light',
    ...
    desc: 'The Solar Collection by AMBERRA — cognac and honey Baltic amber that holds the stored light of the sun. Handcrafted in Bali.',
  ...
  { slug: 'sacred', label: 'The Sacred Collection', lbl: 'Ritual & Protection',
    ...
    desc: 'The Sacred Collection by AMBERRA — amber pieces blessed in Balinese ritual, worn for protection and intention. Handcrafted in Bali.',
    s1: 'In Bali, amber is believed to carry protective energy — a stone of grounding and quiet power. The Sacred Collection gathers our most ceremonial pieces, each passed through water, fire and prayer before it leaves the atelier.',
  ...
  { slug: 'botanica', label: 'The Botanica Collection', lbl: 'Nature & Growth',
    ...
    desc: 'The Botanica Collection by AMBERRA — organic leaf and blossom forms in green and honey Baltic amber. Handcrafted in Bali.',
