...
<style>
.pp-nav{display:flex;align-items:center;gap:26px;padding:0 32px;height:64px;border-bottom:1px solid var(--mist);position:sticky;top:0;background:var(--white);z-index:100}
.pp-nav-logo{font:400 18px/1 var(--serif);letter-spacing:.1em;color:var(--black);text-decoration:none;flex-shrink:0}
.pp-nav-menu{display:flex;gap:22px;flex:1;overflow-x:auto;scrollbar-width:none;-ms-overflow-style:none}
.pp-nav-menu::-webkit-scrollbar{display:none}
.pp-nav-menu a{font:500 11px/1 var(--sans);letter-spacing:.12em;text-transform:uppercase;color:var(--black);text-decoration:none;white-space:nowrap;transition:color .2s}
...
.pp-img-wrap{position:relative;background:#fff;overflow:hidden;aspect-ratio:4/5;max-height:calc(100vh - 92px)}
...
.pp-breadcrumb{font:400 11px/1 var(--sans);letter-spacing:.12em;text-transform:uppercase;color:var(--black);margin-bottom:14px}
...
.pp-name{font:400 30px/1.1 var(--serif);color:var(--black);margin:0 0 10px}
.pp-price{font:400 22px/1 var(--serif);color:var(--black);margin:0 0 14px}
.pp-divider{border:none;border-top:1px solid var(--mist);margin:14px 0}
.pp-desc{font:400 14px/1.55 var(--sans);color:var(--black);margin:0 0 12px}
.pp-material{font:400 13px/1.5 var(--sans);color:var(--black);font-style:italic;margin:0 0 14px}
.pp-about{margin:0 0 16px}
.pp-about-h{font:400 11px/1 var(--sans);letter-spacing:.16em;text-transform:uppercase;color:var(--black);margin:0 0 8px}
.pp-about p{font:400 13px/1.55 var(--sans);color:var(--black);margin:0 0 8px}
.pp-about-care{font-size:12px !important;color:var(--black) !important;font-style:italic}
...
.pp-pk{font:400 10px/1 var(--sans);letter-spacing:.12em;text-transform:uppercase;color:var(--black)}
.pp-pv{font:400 13px/1 var(--sans);color:var(--black)}
.pp-badge-wrap{margin-bottom:10px}
.pp-cta{display:block;width:100%;padding:14px;background:var(--charcoal);color:var(--white);font:400 11px/1 var(--sans);letter-spacing:.18em;text-transform:uppercase;text-align:center;border:none;cursor:pointer;transition:background .2s}
.pp-cta:hover{background:var(--amber)}
.pp-cta-ghost{display:block;width:100%;padding:12px;background:transparent;color:var(--black);font:400 11px/1 var(--sans);letter-spacing:.15em;text-transform:uppercase;text-align:center;text-decoration:none;border:1px solid var(--mist);margin-top:8px;transition:border-color .2s,color .2s}
...
.pp-footer p{font:400 13px/1.7 var(--sans);color:var(--black);max-width:480px;margin:0 auto 16px}
.pp-footer a{color:var(--amber-ink);text-decoration:none}
.pp-related{max-width:1180px;margin:0 auto;padding:0 32px 48px}
.pp-related-head{font:400 13px/1 var(--sans);letter-spacing:.2em;text-transform:uppercase;color:var(--black);text-align:center;margin:0 0 24px}
...
.pp-rel-name{font:400 14px/1.3 var(--serif);color:var(--black);margin:0 0 4px}
.pp-rel-price{font:400 12px/1 var(--sans);color:var(--black)}
...
.pp-trust-t{font:500 11px/1.3 var(--sans);letter-spacing:.03em;color:var(--black)}
.pp-trust-s{font:400 11px/1.4 var(--sans);color:var(--black)}
.pp-trust-item:hover .pp-trust-t{color:var(--amber-ink)}
@media(max-width:760px){.pp-wrap{grid-template-columns:1fr;gap:28px;padding:24px 20px 60px}.pp-info{position:static}.pp-img-wrap{max-height:none;aspect-ratio:4/5}.pp-name{font-size:26px}.pp-related-grid{grid-template-columns:repeat(2,1fr)}}
</style>
</head>
...
<nav class="pp-nav">
  ...
  <a class="pp-nav-cart" href="/shop" aria-label="Cart" style="display:flex;align-items:center;color:var(--black);text-decoration:none;flex-shrink:0">
