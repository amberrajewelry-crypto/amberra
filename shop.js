...
if(typeof wsrc!=='function'){window.wsrc=function(p){if(typeof p!=='string')return p;var w=/^\/?images\/.*\.(jpe?g|png)$/i.test(p)?p.replace(/\.(jpe?g|png)$/i,'.webp'):p;return /\/images\/products\/\d+\.webp$/.test(w)?w+'?v=4':w;};}
